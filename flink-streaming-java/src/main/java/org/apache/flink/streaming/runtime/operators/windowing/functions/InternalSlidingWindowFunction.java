 ...
 */
public interface InternalSlidingWindowFunction<IN, OUT, KEY, W extends Window> extends Function {
	/**
	 ...
	 */
	Tuple2<ArrayList<OUT>, ArrayList<OUT>> process(KEY key, W window, InternalWindowContext context, ArrayList<OUT> outputPrevious, ArrayList<IN> input) throws Exception;
	...
	/**
	 * A context for {@link InternalSlidingWindowFunction}, similar to
