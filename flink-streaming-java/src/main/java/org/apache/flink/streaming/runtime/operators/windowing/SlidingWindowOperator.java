 ...
 */
@Internal
public class SlidingWindowOperator<K, IN, ACC, OUT, W extends Window>
	extends AbstractUdfStreamOperator<OUT, InternalSlidingWindowFunction<ACC, OUT, K, W>>
	...
	public SlidingWindowOperator(
			...
			InternalSlidingWindowFunction<ACC, OUT, K, W> windowFunction,
...
//			}
	...
	private void emitWindowContents(W window, ACC contents) throws Exception {
		...
		processContext.window = window;
		ArrayList<ACC> cont = (ArrayList<ACC>) contents;
		userFunction.process(triggerContext.key, window, processContext, null, cont);
	}
	 ...
	 * {@code WindowContext}.
	 */
	public class WindowContext implements InternalSlidingWindowFunction.InternalWindowContext {
		protected W window;
		...
		public KeyedStateStore globalState() {
			return SlidingWindowOperator.this.getKeyedStateStore();
		}
	...
	public class Context implements Trigger.OnMergeContext {
		...
		public MetricGroup getMetricGroup() {
			return SlidingWindowOperator.this.getMetricGroup();
		}
		...
		public <S extends State> S getPartitionedState(StateDescriptor<S, ?> stateDescriptor) {
			try {
				return SlidingWindowOperator.this.getPartitionedState(window, windowSerializer, stateDescriptor);
			} catch (Exception e) {
